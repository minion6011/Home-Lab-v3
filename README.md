...
- **Music** <br>
  It allows you to **create playlists** and **add songs** from **YouTube** *(through name, link and playlist)* or import a playlist from Spotify (*requires an [app](https://developer.spotify.com/dashboard) `client ID` and `secret`*). <br>
...
## • Credits
### Images & Icons
- **Login background image**, **System icon**: Image by **[Freepik](https://it.freepik.com/)**
